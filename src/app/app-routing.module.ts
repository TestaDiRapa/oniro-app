...
const routes: Routes = [
  ...
  { path: 'homedoc', loadChildren: './homedoc/homedoc.module#HomedocPageModule', canLoad: [AuthGuard]},//,IsUserGuard]},
  { path: 'homedoc/settings', loadChildren: './homedoc/settings/settings.module#SettingsPageModule',canLoad: [AuthGuard]},//, !IsUserGuard] },
// tslint:disable-next-line: max-line-length
  { path: 'homedoc/richieste-pazienti', loadChildren: './homedoc/richieste-pazienti/richieste-pazienti.module#RichiestePazientiPageModule', canLoad: [AuthGuard]},//,IsUserGuard] }
